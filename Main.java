/*Есть простой текстовый файл с адресами IPv4. Одна строка — это один адрес, строка за строкой:
145.67.23.4
8.34.5.23
89.54.3.124
89.54.3.124
...
Cледует вычислить количество уникальных адресов в этом файле, используя как можно меньше памяти и времени.
*/
